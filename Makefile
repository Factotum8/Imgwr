...
# Project:  Imgwr.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -spec linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile Imgwr.pro
#############################################################################
...
Makefile: Imgwr.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile Imgwr.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Imgwr1.0.0/ && $(COPY_FILE) --parents main.h .tmp/Imgwr1.0.0/ && $(COPY_FILE) --parents main.cpp .tmp/Imgwr1.0.0/ && (cd `dirname .tmp/Imgwr1.0.0` && $(TAR) Imgwr1.0.0.tar Imgwr1.0.0 && $(COMPRESS) Imgwr1.0.0.tar) && $(MOVE) `dirname .tmp/Imgwr1.0.0`/Imgwr1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Imgwr1.0.0
